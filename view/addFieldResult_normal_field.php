...
<body>
    ...
    $sql = "SELECT DISTINCT judge_name,record_weight,schedule_round,schedule_status FROM list_judge JOIN list_record ON judge_id = record_judge INNER JOIN list_schedule ON schedule_id= record_schedule_id AND schedule_id = '$s_id'";
    $result = $db->query($sql);
        ...
        <div class="something" style="padding: 100px 15px 60px 15px">
            <form method="post" class="form">
                ...
                <div class="input_row" style="width:45%; margin-right: 4.6%;">
                    <input placeholder="경기 이름" type="text" name="gamename" class="input_text" value="창던지기" maxlength="16" required="" readonly />
                </div>
                ...
                <table cellspacing="0" cellpadding="0" class="team_table" style="border-top: 0px">
                    ...
                    <tbody id="body">
                        ...
                        $sql2 =
                            "SELECT DISTINCT  " .
                            $obj .
                            "record_order,athlete_name FROM list_record,schedule_sports 
                        ...
                        while ($id = mysqli_fetch_array($result2)) {
                            ...
                            if (($row['record_new'] ?? null) == 'y') {
                                $newrecord = $db->query("SELECT worldrecord_athletics FROM list_worldrecord WHERE worldrecord_athlete_name ='" . $row['athlete_name'] . "' AND worldrecord_sports='" . $id['schedule_sports'] . "'");
