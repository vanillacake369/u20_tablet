    <?php
    $s_id = $_GET['id'];
    require_once "../backheader.php"; //B:데이터베이스 연결
    $sql =
        "SELECT DISTINCT schedule_round,schedule_name,schedule_status FROM list_record INNER JOIN list_schedule ON schedule_id= record_schedule_id AND schedule_id = '$s_id'";
    $result = $db->query($sql);
        ...
        <div class="container">
            ...
            <div class="something" style="padding: 100px 15px 60px 15px">
                <form method="post" class="form">
                    ...
                    <h3>심판 이름</h3>
                    <div class="input_row">
                        <?php echo '<input placeholder="심판 이름" type="text" name="refereename" class="input_text" 
