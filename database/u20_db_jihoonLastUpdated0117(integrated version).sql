...
) ENGINE=InnoDB AUTO_INCREMENT=22231 DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 u20.list_athlete:~17 rows (대략적) 내보내기
/*!40000 ALTER TABLE `list_athlete` DISABLE KEYS */;
INSERT IGNORE INTO `list_athlete` (`athlete_id`, `athlete_name`, `athlete_country`, `athlete_region`, `athlete_division`, `athlete_gender`, `athlete_birth`, `athlete_age`, `athlete_profile`, `athlete_schedule`, `athlete_attendance`) VALUES
...
-- 테이블 데이터 u20.list_coach:~0 rows (대략적) 내보내기
/*!40000 ALTER TABLE `list_coach` DISABLE KEYS */;
INSERT IGNORE INTO `list_coach` (`coach_id`, `coach_name`, `coach_country`, `coach_region`, `coach_division`, `coach_duty`, `coach_gender`, `coach_birth`, `coach_age`, `coach_profile`, `coach_schedule`, `coach_attendance`) VALUES
	(1, 'Xiao MING', 'CHN', 'BEIJING', 'CAAF', 'h', 'm', '2004-02-26', 19, '이쁘니2003-10-01_profile.jpeg', '3,4,5', '3,4'),
	(2, 'Jihoon LIM', 'KOR', 'SEOUL', 'KAAF', 's', 'm', '1998-01-09', 25, '만채2004-1-22_profile.jpeg', '12,14', '12,14'),
	(3, 'Junho KIM', 'KOR', 'SEOUL', 'KAAF', 'h', 'm', '2004-02-10', 20, '이쁘니2003-10-01_profile.jpeg', '4,5', '4,5'),
	(4, 'Teng YIMU', 'CHN', 'BEIJING', 'CAAF', 'h', 'f', '2004-01-22', 19, '만채2004-1-22_profile.jpeg', '1,14,15', '1,14,15'),
	(5, 'Qiao HUA', 'CHN', 'BEIJING', 'CAAF', 's', 'f', '2004-01-22', 19, '만채2004-1-22_profile.jpeg', '2,6,15', '2,6,15'),
	(6, 'Ye ZHENYA', 'CHN', 'BEIJING', 'CAAF', 'h', 'f', '2004-01-22', 19, '만채2004-1-22_profile.jpeg', '2,12,15', '2,12,15'),
	(7, 'Vineet TAMHANAKAR', 'IND', 'NEW DELHI', 'IAAF', 's', 'm', '2004-01-22', 19, '만채2004-1-22_profile.jpeg', '3,9,24', '3,9,24'),
	(8, 'Daas BADAKAR', 'IND', 'NEW DELHI', 'IAAF', 'h', 'm', '2004-01-22', 19, '만채2004-1-22_profile.jpeg', '1,22', '1,22'),
	(9, 'Benegal UPASANI', 'IND', 'NEW DELHI', 'IAAF', 's', 'f', '2004-01-22', 19, '만채2004-1-22_profile.jpeg', '10', '10'),
	(10, 'Waazir MALLAYA', 'IND', 'NEW DELHI', 'IAAF', 'h', 'm', '2004-01-22', 19, '만채2004-1-22_profile.jpeg', '10,11,13', '10,11,13'),
	(11, 'Yuk Hyun LEE', 'KOR', 'SEOUL', 'KAAF', 's', 'f', '2004-01-22', 19, '만채2004-1-22_profile.jpeg', '13,22', '13,22'),
	(20, 'Yeoncheol Kim', 'KOR', 'Seoul', 'KAAF', 'h', 'm', '2004-12-22', 20, NULL, '11,13', '11,13'),
	(21, 'takuya KIMURA', 'JPN', 'Tokyo', 'JAAF', 'h', 'f', '2004-12-22', 20, NULL, '9', '9'),
	(22, 'Yong Quan BAY', 'CHN', 'Tian', 'CAAF', 's', 'f', '2004-12-22', 20, NULL, '5', '5');
...
-- 테이블 데이터 u20.list_log:~104 rows (대략적) 내보내기
...
-- 테이블 데이터 u20.list_record:~9 rows (대략적) 내보내기
/*!40000 ALTER TABLE `list_record` DISABLE KEYS */;
INSERT IGNORE INTO `list_record` (`record_id`, `record_athlete_id`, `record_schedule_id`, `record_pass`, `record_result`, `record_record`, `record_new`, `record_memo`, `record_medal`, `record_order`, `record_judge`, `record_trial`, `record_wind`, `record_weight`, `record_group`) VALUES
...
-- 테이블 데이터 u20.list_schedule:~11 rows (대략적) 내보내기
/*!40000 ALTER TABLE `list_schedule` DISABLE KEYS */;
INSERT IGNORE INTO `list_schedule` (`schedule_id`, `schedule_sports`, `schedule_name`, `schedule_gender`, `schedule_round`, `schedule_location`, `schedule_start`, `schedule_status`, `schedule_date`, `schedule_division`, `schedule_result`) VALUES
